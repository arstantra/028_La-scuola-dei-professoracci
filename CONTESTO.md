...
```
index.html                 corridoio: porte generate da config + porte custom + porta "crea"
...
assets/professoracci.js    config dei 6 prof (persona, livelli, voce, tema, SVG, decorazioni, messaggi)
...
- Punteggio condiviso: `localStorage['professoracci_punti']`
