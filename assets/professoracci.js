...
var PROFS = {
  ...
  missspelling: {
    ...
    boardtitle:'English — spot the mistake!',
    ...
    benvenutoLavagna:'Press «NEW LESSON» and listen carefully. My English is impeccable... and if you find a mistake, it is the chalk\'s fault, of course!',
    ...
    msg:{
      ...
      pronto:'Here we are! A flawless lesson. Mistakes? Oh no, darling. Never.',
      noLezione:'First ask me for a lesson, my dear!',
      vuoto:'The box is empty, darling! Write your correction, please.',
      ...
      bravi:['Oh dear... you are right. The tea made me do it!', 'Goodness gracious! You caught me! Ten points!', 'Oh bother! Well spotted! Ten points for you!'],
